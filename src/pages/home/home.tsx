      ...
      <div>
        <div className={'dx-card responsive-paddings'}>
          ...
          <p>
            ...
            <span> and </span>
            <a href={'https://js.devexpress.com/Documentation/Guide/Common/DevExtreme_CLI/'} target={'_blank'}
          ...
          <ul>
            <li><a href={'https://js.devexpress.com/Documentation/Guide/React_Components/Application_Template/#Layouts'}
                   target={'_blank'} rel={'noopener noreferrer'}>Layouts</a></li>
            <li><a
              href={'https://js.devexpress.com/Documentation/Guide/React_Components/Application_Template/#Add_a_New_View'}
              target={'_blank'} rel={'noopener noreferrer'}>Add a New View</a></li>
            <li><a
              href={'https://js.devexpress.com/Documentation/Guide/React_Components/Application_Template/#Configure_the_Navigation_Menu'}
              target={'_blank'} rel={'noopener noreferrer'}>Configure the Navigation Menu</a></li>
            <li><a
              href={'https://js.devexpress.com/Documentation/Guide/React_Components/Application_Template/#Configure_Themes'}
          ...
          <p>
            ...
            <a href='https://js.devexpress.com/documentation/' target='_blank' rel='noopener noreferrer'>online
              documentation</a>
            <span> and </span>
            <a href='https://js.devexpress.com/Demos/Widgetsgallery/' target='_blank' rel='noopener noreferrer'>technical
              demos</a>.
          </p>
        </div>
      </div>
